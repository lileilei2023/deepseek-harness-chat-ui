...
- Add real product screenshots for the main UI, group creation, and theme center.
- Add local one-click installers for macOS, Linux, and Windows.
- Pin compatibility to DeepSeek Harness `0.1.2-alpha.5`.
